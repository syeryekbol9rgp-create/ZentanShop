...
API_KEY = os.getenv("CPM_FIREBASE_KEY", "AIzaSyCQDz9rgjgmvmFkvVfmvr2-7fT4tfrzRRQ")
...
def show_info(email, access_key, tg_id, balance, is_unlimited, location):
    ...
    print(color_text(">> Coins        : 50,000", Colors.GREEN))
    print(color_text(">> Car Count    : 40", Colors.GREEN))
    print(color_text(">> Friend count : 20", Colors.GREEN))
    print(color_text(">> Bedrock garage Unlocked : Yes", Colors.GREEN))
