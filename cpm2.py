...
def banner():
    ...
    print(horizontal_colors("Car Parking Multiplayer 2 Tool".center(60)))
    print(horizontal_colors("="*60))
...
def show_info(email, access_key, tg_id, balance, is_unlimited, location):
    ...
    print(color_text(f">> Friend count  : 20", Colors.GREEN))
    print(color_text(f">> unlocked bedrock garage : Yes", Colors.GREEN))
    ...
    print(color_text("(02): Change password     5K", Colors.GREEN))
...
if __name__ == "__main__":
    try:
        ...
        print()  # move cursor off the ^C line
        farewell()
